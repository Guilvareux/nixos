...
client_addr = "127.0.0.1 100.64.0.5"
...
#license_path = "/etc/nixos/cloud/consul.d/consul.hclic"
...
tls {
   defaults {
      ca_file = "/etc/nixos/cloud/consul.d/certs/consul-agent-ca.pem"
      cert_file = "/etc/nixos/cloud/consul.d/certs/dc1-server-consul-0.pem"
      key_file = "/etc/nixos/cloud/consul.d/certs/dc1-server-consul-0-key.pem"
